...
import { constrain, getAutofitScale, getContainerDimensions, getDimensions, getImageOverflow, getMinScale, getPinchLength, getPinchMidpoint, getRelativePosition, isEqualDimensions, isEqualTransform, negate, setRef, snapToTarget, tryCancelEvent } from './Utils';
...
export default class PinchZoomPan extends React.Component {
  ...
  zoomIn(midpoint, speed = 0, factor = 0.3) {
    midpoint = midpoint || {
    ...
    return (
      <div style={containerStyle}>
        {zoomButtons && this.isImageReady && this.isTransformInitialized && <ZoomButtons
          ...
          onReset={()=>this.applyInitialTransform(ANIMATION_SPEED)}
        />}
