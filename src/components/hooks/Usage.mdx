...
import * as IntervalStories from '../hooks/useInterval.stories'
import * as StateRefStories from '../hooks/useStateRef.stories'
import * as URLStateStories from '../hooks/useUrlState.stories'
...
<Canvas>
  {/* <Story id="hooks-useinterval--mdx-example" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}

  <Story of={IntervalStories.MDXExample}/>
  <Source of={IntervalStories.MDXExample} type="code"/>
...
<Canvas>
  ...
  <Source of={StateRefStories.Default} type="code"/>
...
<Canvas>
  {/* <Story id="hooks-useurlstate--default" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}

  <Story of={URLStateStories.Default}/>
  <Story of={URLStateStories.Default} type="code"/>
