...
import * as ColumnTypesDatagridStories from '../DataGrid2/ColumnTypes.stories'
import * as DatagridStories from '../DataGrid2/index.stories'
...
<Story of={ColumnTypesDatagridStories.Default}/>
...
<Canvas>
  {/* <Story id="datagrid-datagrid2--infinite-loader" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}
  <Story of={DatagridStories.InfiniteLoader}/>
  
  <Source of={DatagridStories.InfiniteLoader} type="code"/>
...
<Canvas>
  ...
  <Story of={DatagridStories.ServerSort}/>
  <Source of={DatagridStories.ServerSort} type="code"/>
</Canvas>
...
<Canvas>
  ...
  <Story of={DatagridStories.ServerFilter}/>
  <Source type="code" of={DatagridStories.ServerFilter}/>
...
<Story of={ColumnTypesDatagridStories.Basic}/>
...
<Story of={ColumnTypesDatagridStories.CellRenderer}/>
